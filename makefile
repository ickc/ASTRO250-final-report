...
pandocArgCommon := -f markdown+autolink_bare_uris-fancy_lists -V linkcolorblue -V citecolor=blue -V urlcolor=blue -V toccolor=blue --pdf-engine=$(pandocEngine) -M date="`date "+%B %e, %Y"`" --filter=pandoc-citeproc --bibliography=citation.bib --csl=the-astronomy-and-astrophysics-review.csl
## MD
